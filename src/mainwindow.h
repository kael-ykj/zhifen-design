...
private:
    ...
    QAction *m_moveAct, *m_copyAct, *m_rotateAct, *m_scaleAct, *m_mirrorAct, *m_explodeAct, *m_offsetAct, *m_queryDistAct, *m_queryAreaAct, *m_queryPointAct, *m_linkCalcAct, *m_bomAct, *m_sysDiagramSketchAct, *m_sysDiagramFormalAct, *m_coverageSimAct, *m_smartRouteAct, *m_powerBalanceAct, *m_elevatorToolAct, *m_leakyCableToolAct, *m_b2bToolAct, *m_dimLinearAct, *m_dimAlignedAct, *m_dimRadiusAct, *m_dimDiameterAct, *m_dimAngularAct, *m_sheetSetAct, *m_auditLogAct, *m_copyModeAct, *m_eraseAct;
