...
{
    // 系统图切割功能（基于新拓扑模型，后续完善）
    QMessageBox::information(this, "系统图切割",
        "系统图切割功能正在重构中，将基于新的拓扑模型实现。\n\n"
        "当前版本支持：系统图生成、功率计算、材料统计。\n"
        "切割分页功能将在后续版本完善。");
}
...
{
    // 平面图与系统图双向关联（基于新拓扑模型，后续完善）
    QMessageBox::information(this, "双向关联",
        "平面图与系统图双向关联功能正在重构中。\n\n"
        "新的拓扑模型已支持器件连接关系和功率计算，\n"
        "双向关联将在后续版本中实现。");
}
